package faa.gov.tfms.application.entity;
...
public class MassEditEntity implements Serializable {

	private static final long serialVersionUID = 1L;
	public static final Logger logger = LoggerFactory.getLogger(MassEditEntity.class);
	...
	public MassEditEntity(){}  
	
    public MassEditEntity(String carBrand, String carModel, String horsepower, String carEngine) {
