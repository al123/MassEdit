...
import faa.mass.edit.view.MassEditViewComponent;

@Route
public class MassEditMainView extends VerticalLayout implements LocaleChangeObserver {

    private RouterLink link;

    public MassEditMainView(@Autowired Greeter greeter,
            @Autowired MassEditTemplate template) {
